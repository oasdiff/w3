            ...
            content: (
              <>
                ...
                <p className="text-lg text-[var(--foreground)] leading-relaxed mt-4">
                  Try it yourself using our interactive <a href="/diff-calculator?spec1=/data/spec1.yaml&spec2=/data/spec2.yaml&mode=breaking" className="font-medium text-emerald-400 hover:text-emerald-300 transition-colors">diff-calculator</a>.
                </p>
              </>
            )
          },
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p className="text-lg text-[var(--foreground)] leading-relaxed mt-4">
                  Try it yourself using our interactive <a href="/diff-calculator?spec1=/data/spec1.yaml&spec2=/data/spec2.yaml&mode=changelog" className="font-medium text-emerald-400 hover:text-emerald-300 transition-colors">diff-calculator</a>.
                </p>
              </>
            )
          },
          ...
          },
          {
            ...
            content: (
              <>
                ...
                <p className="text-lg text-[var(--foreground)] leading-relaxed mt-4">
                  Try it yourself using our interactive <a href="/diff-calculator?spec1=/data/spec1.yaml&spec2=/data/spec2.yaml&mode=diff" className="font-medium text-emerald-400 hover:text-emerald-300 transition-colors">diff-calculator</a>.
                </p>
